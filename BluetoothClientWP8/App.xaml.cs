...
namespace BluetoothClientWP8
{
    public partial class App : Application
    {
        ...
        private void ParsePushOnToastNotificationReceived(object sender, NotificationEventArgs notificationEventArgs)
        {
        ...
        /*
          MessageBox.Show("fufu");
                var json = ParsePush.PushJson(notificationEventArgs);
                object objectId;
